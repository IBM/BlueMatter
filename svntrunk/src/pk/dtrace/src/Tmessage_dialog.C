                             ...
                             DialogType BoxType )
{
   ...
   if (BoxType == ERROR)
   {
     Titlestring = XmStringCreateSimple((char *) "Error");
     ...
     wMessageDialog = XmCreateErrorDialog(ParentWidget,(char *) "ErrorDialog",args,n);
   ...
   else if (BoxType == WARNING)
   {
     ...
     wMessageDialog = XmCreateWarningDialog(ParentWidget,(char *) "ErrorDialog",args,n);
