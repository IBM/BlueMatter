...
set linestyle 5
set linestyle 6
plot 'fft_mpi_20050406.dat' index 1 using ($1*$2*$3):4 title '$128^3$ MPI' with linespoints,\
'fft_pkt_sc_20050418.dat' using ($1*$2*$3):5 title '$128^3$ Blade Single Core' with linespoints,\
'../fft.700mhz.bw.128' using 1:8 title 'Bandwidth-limited Estimate for $128^3$' with lines,\
'fft_mpi_20050406.dat' index 0 using ($1*$2*$3):4 title '$64^3$ MPI' with linespoints,\
'fft_pkt_sc_20050418.dat' using ($1*$2*$3):($4 > 0 ? $4 : 1/0) title '$64^3$ Blade Single Core' with linespoints,\
'../fft.700mhz.bw.64' using 1:8 title 'Bandwidth-limited Estimate for $64^3$' with lines
