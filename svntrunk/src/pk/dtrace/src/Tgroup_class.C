                                              ...
                                              XButtonPressedEvent *event)
{
  ...
  switch (event->button)
  {
      ...
      case Button3:
          ...
          n = 0;
          Group->wPopUp = XmCreatePopupMenu(w,(char *) "wPopUp",args,n);
          ...
          (void) CreatePushButton(Group->wPopUp,(char *) "Delete",
          ...
          (void) CreatePushButton(Group->wPopUp,(char *) "Save...",
          ...
          (void) CreatePushButton(Group->wPopUp,(char *) "Properties...",
...
Widget  TraceGroup::CreateButton()
{
   ...
   wVirtualGroupButton = 
           XmCreatePushButton( GetWindow()->formVirtualMap, (char *) ".", args, n );
