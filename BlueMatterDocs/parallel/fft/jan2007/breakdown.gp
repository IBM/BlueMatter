...
'SPI/regular/fft_spi_regular_double.dat' index 1 using 2:($3/1e9) title 'SPI reg. double A2A X' with linespoints,\
'SPI/regular-float/fft_spi_regular_float_64_64_64.dat' index 2 using 2:($3/1e9) title 'SPI reg. float A2A X' with linespoints,\
'SPI/fast/fft_spi_fast_double_64_64_64.dat' index 3 using 2:($3/1e9) title 'SPI fast float A2A X' with linespoints

#'SPI/regular/fft_spi_regular_double.dat' index 2 using 2:($3/1e9) title 'SPI reg. double A2A Y' with linespoints,\
#'SPI/regular/fft_spi_regular_double.dat' index 3 using 2:($3/1e9) title 'SPI reg. double A2A Z' with linespoints,\
