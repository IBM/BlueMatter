...
GroupPropDialog::GroupPropDialog(TraceGroup *pParentGroup)
{
   ...
   wGroupPropDialog = XmCreateFormDialog(ParentItem->ParentWindow->form0,
                                      "GroupPropDialog",args,n);


   /* Create the trace file title box */
   str = XmStringCreateSimple("Trace File:");
   ...
   str = XmStringCreateSimple("Contour Trace");
   ...
   Sep1 =  XmCreateSeparatorGadget(wGroupPropDialog,"Sep1",args,n);

   xmString = XmStringCreateSimple("Cancel");

   CancelButton = CreatePushButton(wGroupPropDialog,"PropsCancelButton",
   ...
   OKButton = CreatePushButton(wGroupPropDialog,"PropsOKButton",
