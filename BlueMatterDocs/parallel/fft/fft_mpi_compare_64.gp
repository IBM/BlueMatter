...
set output 'fft_mpi_compare_64_20050511.mp'
set size 1.2, 1.2
set key top right
set xrange [1:5000]
set logscale xy
...
plot './mariae/fftbgmpi_20040714.dat' index 1 using 4:5 title '$64^3$ MPI Collective (MPICH2)' with linespoints,\
'./mariae/fftbgwmpi_20050511.dat' index 1 using 1:5 title '$64^3$ MPI Collective (optimized)' with linespoints,\
...
#'fft_mpi_20050406.dat' index 0 using ($1*$2*$3):4 title '$64^3$ MPI Collective (optimized)' with linespoints,\
#'./mariae/fftbgmpi_20050206.dat' using 1:3 title '$64^3$ MPI Collective (optimized)' with linespoints,\
