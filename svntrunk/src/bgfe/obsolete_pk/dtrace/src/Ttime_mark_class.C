...
//     XtSetArg( args[n],XmNdragReceiverProtocolStyle, XmDRAG_NONE); n++;
     ...
     // Create the Widget
     StartButton = XmCreatePushButton( ParentWindow->formTime, ".", args, n );
...
//     XtSetArg( args[n],XmNdragReceiverProtocolStyle, XmDRAG_NONE); n++;
     ...
     // Create the Widget
     StopButton = XmCreatePushButton( ParentWindow->formTime, ".", args, n );
...
//     XtSetArg( args[n],XmNdragReceiverProtocolStyle, XmDRAG_NONE); n++;
     ...
     // Create the Widget
     ControlButton = XmCreatePushButton( ParentWindow->formTime, ".", args, n );
