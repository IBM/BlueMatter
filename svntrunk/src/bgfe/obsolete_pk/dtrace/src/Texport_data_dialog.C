                           ...
                           LTime         EndTime)
{
  ...
  CancelxmString = XmStringCreateSimple("Cancel");
  ...
  wExportDataMain = XmCreateTemplateDialog( wDialogShell,
   ...
   xmString = XmStringCreateSimple("From Time");
   ...
   xmString = XmStringCreateSimple("To Time");
  ...
  xmString = XmStringCreateSimple("Export Method");
  ...
  xmString = XmStringCreateSimple("Export to file");
  ...
  xmString = XmStringCreateSimple("Export to plot");
  ...
  xmString = XmStringCreateSimple("File Options");
  ...
  // Create the Export to file toggle
  xmString = XmStringCreateSimple("Export all trace points");
  ...
  // Create the Export to plot toggle
  xmString = XmStringCreateSimple("Export selected trace points");
  ...
  xmString = XmStringCreateSimple("File Format Options");
  ...
  // Create the Export to file toggle
  xmString = XmStringCreateSimple("Seconds");
  ...
  // Create the Export to file toggle
  xmString = XmStringCreateSimple("LTime");
  ...
  xmString = XmStringCreateSimple("Raw Data");
  ...
  xmString = XmStringCreateSimple("List Of Traces");
  ...
  fm_TraceFileList = XtVaCreateManagedWidget("fm_ExpDialogTraceFileList",
   ...
   wPrevTraceList = XmCreateScrolledList(fm_TraceFileList,
                                         "wExpDialogPrevTraceList",args,n);
   ...
   wPostTraceList = XmCreateScrolledList(fm_TraceFileList,
                                         "wExpDialogPostTraceList",args,n);
