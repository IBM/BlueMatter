...
TracerApplication::TracerApplication(int argc, char **argv)
{
  ...
  ExportingDataFlag = FALSE ;
   ...
   mainW = XmCreateMainWindow( top, (char *) "main", args, n);
...
void TracerApplication::CreateMainMenu()
{
   ...
   MenuBar = XmCreateMenuBar( mainW,(char *)  "menu", args , n );

   XtManageChild( MenuBar);

   s = XmStringCreateLocalized((char *) "File");
  
   n =0;
   FilePulldown = XmCreatePulldownMenu( MenuBar,(char *) "Pulldown", args, n );
   ...
   n =0;
   OptionPulldown = XmCreatePulldownMenu( MenuBar,(char *) "Pulldown", args, n );

   s = XmStringCreateLocalized((char *) "Options");
...
void TracerApplication::CreateButtonBar(Widget Parent)
{
   ...
   xmString = XmStringCreateSimple((char *) "Create Trace View");

   Button = CreatePushButton(ButtonBarRowColumn,(char *) "cbCreateTrace",
   ...
   xmString = XmStringCreateSimple((char *) "Save All Groups");

   Button = CreatePushButton(ButtonBarRowColumn,(char *) "cbSaveAllSets",
   ...
   xmString = XmStringCreateSimple((char *) "Previous Hit");

   Button = CreatePushButton(ButtonBarRowColumn,(char *) "WarpClickDown",
   ...
   xmString = XmStringCreateSimple((char *) "Next Hit");

   Button = CreatePushButton(ButtonBarRowColumn,(char *) "WarpClickUp",
   ...
   xmString = XmStringCreateSimple((char *) "Export Data");

   ExportButton = CreatePushButton(ButtonBarRowColumn,(char *) "Export",
...
void TracerApplication::CreateScaleToggles(Widget Parent)
{
   ...
   ScaleRadioBox = XmCreateRadioBox(fmScaleRadioBox,(char *) "ScaleRadioBox", args, n);
...
void TracerApplication::CreateZoomButtons(Widget Parent)
{
   ...
   bnZoomIn = CreateArrowButton(rcZoomSpinBox,(char *) "Zoom In",
...
/*   XtAddCallback( bnZoomIn, XmNarmCallback,
   ...
   bnZoomOut = CreateArrowButton(rcZoomSpinBox,(char *) "Zoom Out",
...
/*   XtAddCallback( bnZoomOut, XmNarmCallback,
   ...
   XmTextSetString(tbZoomFactor,(char *) "2");
...
void TracerApplication::CreateScaleArea(Widget Parent)
{
   ...
   xmString = XmStringCreateSimple((char *)"Current Scale");
...
void TracerApplication::CreateMessageArea(Widget Parent)
{
  ...
  int n =0;
   ...
   tbMessage = XmCreateScrolledText(frMessageWindow,(char *)"tbMessage", args, n);
...
void TracerApplication::run()
{
   ...
   if ((strcmp(RegExpPath,"") != 0) && (strcmp(StartDirectory,"") != 0))
   {
      // Auto-load group
     BegLogLine(PKFXLOG_TRACER)
       << "TracerApplication::run AutoLoadGroups" 
       << EndLogLine ;
     BegLogLine(PKFXLOG_TRACER)
       << "TracerApplication::run StartDirectory=" << StartDirectory
       << " RegExpPath=" << RegExpPath
       << EndLogLine ;
      CurrentWindow->AutoLoadGroups(StartDirectory, RegExpPath);
      BegLogLine(PKFXLOG_TRACER)
        << "TracerApplication::run AutoLoadGroups returns" 
        << EndLogLine ;
                            ...
                            XtPointer call_data)
{
  ...
  {
    //
    App->SendMessageText((char *)"Select range to export using Button 3\n");
    App->ExportingDataFlag = TRUE ;

    xmString = XmStringCreateSimple((char *)"Cancel Export");
