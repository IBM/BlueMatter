...
set output 'fft_fftw_speedup.mp'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set xlabel "Number of processors" 0.000000,0.000000  font ""
set x2label "" 0.000000,0.000000  font ""
set xrange [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Speedup" 0.000000,0.000000  font ""
...
MOUSE_X = 0.794224261520982
MOUSE_Y = 30.5682128757803
MOUSE_X2 = -0.0828303114845747
MOUSE_Y2 = 1.220330959712
MOUSE_BUTTON = 1
MOUSE_SHIFT = 0
MOUSE_ALT = 0
MOUSE_CTRL = 0
...
ideal(x)=x
plot ideal(x) title 'Ideal Speedup',\
'./mariae/fftbgwmpi_20050511.dat'index 0 u ($1):(1.059216/$5) title "FFTBG on MPI" w lp,\
'./mariae/fftwbgmpi_20050511.dat' index 2 u ($1):(.709682/$2) title "FFTW Port" w lp
#    EOF
set output
set term win
