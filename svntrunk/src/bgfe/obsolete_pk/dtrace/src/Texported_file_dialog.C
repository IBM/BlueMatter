                                       ...
                                       int           NumFilesExported)
{
  ...
  wExportedDataMain = XmCreateFormDialog( ParentWidget,
   ...
   Sep1 =  XmCreateSeparatorGadget(wExportedDataMain,"ExpSep1",args,n);
  ...
  xmString = XmStringCreateSimple("List Of Exported Trace Files");
  ...
  fm_TraceFileList = XtVaCreateManagedWidget("fm_ExpTraceFileList",
   ...
   xmString = XmStringCreateSimple("View");

   wViewButton = CreatePushButton(wExportedDataMain,"ExpViewbutton",
                 cbViewButtonPressed,
                 (XtPointer) this);
   ...
   wCancelButton = CreatePushButton(wExportedDataMain,"ExpCancelbutton",
