...
//   XtVaSetValues(mu_color,XmNbuttonSet,6,NULL);
   ...
   xmString = XmStringCreateSimple("Number Of Hits (Prev):");
   ...
   xmString = XmStringCreateSimple("Number Of Hits (Post):");
   ...
   Sep1 =  XmCreateSeparatorGadget(wPropDialog,"Sep1",args,n);
                                  

   CancelButton = CreatePushButton(wPropDialog,"PropsCancelButton",
   ...
   OKButton = CreatePushButton(wPropDialog,"PropsOKButton",
                                        ...
                                        int SelectedValue)
{
  ...
  mu_GC = XmCreatePulldownMenu( parent, "mu_GC", args, 0 );
  str = XmStringCreateSimple("Graphic Context:");
  ...
  mu_GCOption = XmCreateOptionMenu( parent, "GCoption", args, n );
