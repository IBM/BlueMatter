...
Widget TraceItem::CreateButton( )
{
   ...
   // Create the Widget
   w = XmCreatePushButton( GetWindow()->formLabel,(char *)  ".", args, n );
  ...
  switch (event->button)
  {
    ...
    case Button1:
     ...
     case Button3:
          ...
          Item->wPopUp = XmCreatePopupMenu(w,(char *) "wPopUp",args,n);
          ...
          (void) CreatePushButton(Item->wPopUp,(char *) "Delete",
          ...
          wButton= CreatePushButton(Item->wPopUp,(char *) "MakeFocus",
                 (XtCallbackProc) Item->cbMakeFocus,
                 (XtPointer) Item);

          xmString = XmStringCreateSimple((char *) "Make Focus");
          ...
          wButton= CreatePushButton(Item->wPopUp,(char *) "GotoStart",
                 (XtCallbackProc) Item->cbGotoStart,
                 (XtPointer) Item);

          xmString = XmStringCreateSimple((char *) "Goto Start");
          ...
          wButton= CreatePushButton(Item->wPopUp,(char *) "GotoEnd",
                 (XtCallbackProc) Item->cbGotoEnd,
                 (XtPointer) Item);

          xmString = XmStringCreateSimple((char *) "Goto End");
          ...
          (void) CreatePushButton(Item->wPopUp,(char *) "Properties...",
