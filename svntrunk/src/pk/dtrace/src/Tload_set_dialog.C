...
LoadGroup::LoadGroup(TracerWindow *ParentWindow)
{
   ...
   xmString = XmStringCreateSimple((char *) "Trace Data File");
   ...
   xmString = XmStringCreateSimple((char *) "File");
   ...
   XmStringFree(xmString);
   xmString = XmStringCreateSimple((char *) "Select File");

   wTraceFileButton = CreatePushButton(fm_TraceFile,(char *) "wTraceFileButton",
   ...
   {
      XmTextSetString(wtbLoadGroupTraceFile,(char *) "");
   }
   else
   {
   ...
   xmString = XmStringCreateSimple((char *) "Regular Expression File");
   ...
   wRexpFileButton = CreatePushButton(fm_RexpFile,(char *) "wRexpFileButton",
                 cbFileSelectButtonPressed,
                 (XtPointer) this);
   ...
   {
      XmTextSetString(wtbLoadGroupRexpFile,(char *) "");
   }
   else
   {
   ...
   wOKButton = CreatePushButton(wLoadGroupMain,(char *) "OKbutton",
                 cbOKButtonPressed,
                 (XtPointer) this);
   ...
   wCancelButton = CreatePushButton(wLoadGroupMain,(char *) "Cancelbutton",
   ...
   Sep1 =  XmCreateSeparatorGadget(wLoadGroupMain,(char *) "Sep1",args,n);
                                                   ...
                                                   XtPointer call_data)
{
  ...
  {
    s = XmStringCreateLocalized((char *) "Trace File Selection");
  ...
  {
    s = XmStringCreateLocalized((char *) "Regular Expressoion File Selection");
