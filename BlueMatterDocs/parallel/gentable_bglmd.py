...
print '%12.3e' % (float(singleNode_gp[5])/clock),
print '%12.3e' % (float(singleNode_gfr[6])/clock),
print '%12.3e' % (unity),
print '%12.3e' % (unity)
...
for p in ((2,2,2),(2,4,4),(4,4,4),(8,4,4),(8,8,4),(8,8,8),(8,8,16),(8,16,16),(16,16,16),(16,16,32),(16,32,32)):
    ...
    print '%12d %4d %4d %4d' % (procs,p[0],p[1],p[2]),
    print '%12.3e' % (float(gpTS[5])/clock),
    print '%12.3e' % (float(gfrTS[6])/clock),
    print '%12.3e' % (float(singleNode_gp[5])/float(gpTS[5])),
