...
a=-7.9e-07
b=0.0
fit f(x) 'lambda_repressor_2fs_ts.dat' every 5 using ($1*tsconv):(($2-e0)/ke0) via a,b
...
plot 'lambda_repressor_2fs_ts.dat' every 5 using ($1*tsconv):(($2-e0)/ke0) title 'Lamba Repressor (2 fs)' with lines,\
